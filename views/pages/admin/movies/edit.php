                ...
                <div class="row g-2">
                    <div class="col-md">
                        ...
                        <div class="form-floating">
                            <input type="text" name="name" value="<?= $movie->name() ?>" class="form-control <?= $session->has('name') ? 'is-invalid' : '' ?>" id="name" placeholder="Драйв">
                        ...
                        <div class="form-floating mt-2">
                            <textarea name="description" class="form-control <?= $session->has('description') ? 'is-invalid' : '' ?>" placeholder="Описание" id="floatingTextarea2" style="height: 100px"><?= $movie->description() ?></textarea>
                        ...
                        <div class="mt-2">
                            ...
                            <select name="category_id" id="category" class="form-select">
                                <?php foreach ($categories as $category) { ?>
                                    <option value="<?= $category->id() ?>" <?= $category->id() === $movie->categoryId() ? 'selected' : '' ?>><?= $category->name() ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
